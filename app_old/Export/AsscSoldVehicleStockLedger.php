    ...
    public function collection()
    {
            ...
            $rto_date = $report_to_date;
                ...
                $vehicle_stocks = DB::table('dealer_booking_vehicle_info')
						        ...
						        ->select('dealer_booking_vehicle_info.id','dealer_booking_vehicle_info.chassis_no','dealer_booking_vehicle_info.booking_date','vehicle_type.type_of_vehicle','colors.type_of_color','main_model.model','dealers.dealer_name','dealer_booking_vehicle_info.assc_customer_name','dealer_booking_vehicle_info.contact_no')
						...
						array_push($array_of_assc_sold_stock,new AsscSoldVehicleStock("Delaer Name","Date","Vehicle Type","Vehicle Model","Vehicle Color","Chassis No","Customer Name","Contact No"));
						...
						if(!empty($vehicle_stocks))
						{
								foreach ($vehicle_stocks as $farray ) {
									$sold_date = date("d-m-Y", strtotime($farray->booking_date));
									...
									array_push($array_of_assc_sold_stock,new AsscSoldVehicleStock($dealer_name,$sold_date,$vehicle_type,$vehicle_model,$vehicle_color,$chassis_no,$customer_name,$contact_no));
