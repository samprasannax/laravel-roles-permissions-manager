...
//print "<br>Sum Total Psid ".$sum_of_total_paid;
			...
			//	print "<br>Sum Total Manual ".$manual_return;			
	...
	//print "<br>Sum Total Dealer Manual ".$dealer_return_vehicle_info;
	//print "<br>Sum Total Manual ".$dealer_warranty_total;
						...
						while (strtotime($report_from_date) <= strtotime($report_to_date)) {
						    ...
						    if($dealer_warranty_send !='')
							{
								foreach ($dealer_warranty_send as $ew ) {
        							...
        							array_push($ledger_report_items,new LedgerReport($warranty_date,"EW",$warranty_qty."*".$warranty_amount ,"",$warranty_total,$find_opening_bal,"fff"));
                                    array_push($ledger_report_items,new LedgerReport("","","","","","",""));
...
$stock_in_hands = DB::table('vehicle_stock')
                ...
                ->select('vehicle_type.type_of_vehicle','colors.type_of_color','main_model.model','vehicle_stock.chassis_no')
 ...
 $assc_stock_in_hands = DB::table('dealer_booking_vehicle_info')
       ...
       $vehicle_stocks = DB::table('self_sale_vehicle_info')
						        ...
						        ->select('self_sale_vehicle_info.rto_date','self_sale_vehicle_info.id','self_sale_vehicle_info.chassis_no','self_sale_vehicle_info.delivery_date','vehicle_type.type_of_vehicle','colors.type_of_color','main_model.model','customers.customer_name','sales_person.sales_person_name')
	...
	public function total_finance_amount()
		{
			...
			if (! Gate::allows('admin')) 
			{
           	...
           	$total_finances = DB::table('bank')			 		             
				 ...
				 return view('/total-finance-amount', compact(['total_finances']));
