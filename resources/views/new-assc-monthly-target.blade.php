      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">           
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/insert_assc_monthly_target" method="POST" enctype="multipart/form-data">
                @csrf
