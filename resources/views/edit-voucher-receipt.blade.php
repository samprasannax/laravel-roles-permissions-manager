  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Expense Receipt</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">           
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/update_voucher_receipt" method="POST" enctype="multipart/form-data">
                @csrf
                 <div class="box-body">
                 ...
                 <input type="hidden" name="order_id" id="order_id" value="{{ $edit_voucher_receipt[0]->order_id }}">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="voucher_no" name="voucher_no" aria-describedby="emailHelp" placeholder="Expense No" value="{{ $edit_voucher_receipt[0]->voucher_no }}" readonly="true">
                                            </div>
                                        </div> 
                                                ...
                                                <select class="form-control select2" name="voucher_category" id="voucher_category" required="true">
                                                  <option value="">Select </option>
                                                            ...
                                                            @foreach($voucher_categorys as $voucher_category)
                                                                <option value="{{$voucher_category->id}}" @if($voucher_category->id==$edit_voucher_receipt[0]->voucher_category) selected @endif >{{strtoupper($voucher_category->voucher_name)}}</option>
                                                            @endforeach
