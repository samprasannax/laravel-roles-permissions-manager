	...
	<div class="main-div">
		 ...
		 <div class="header">
		 	...
		 	<div class="header-left">
		 		...
		 		<p style="font-weight: bold;">Cell : 77898 55564 </p>
		 	</div>
		 ...
		 <div class="border-content" >
			 ...
			 <div class="body-content">
			 	<p>Received with thanks from M/s.<span class="underline1" ><?php echo $print_customer_receipt[0]->customer_name; ?></span> the sum of Rupees  <span class="underline2" ><?php echo $result; ?></span> by <span class="underline3" ><?php  $payment_mode = $print_customer_receipt[0]->payment_mode;
