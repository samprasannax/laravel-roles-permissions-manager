  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/voucher-receipt-list">View Expense Receipt</a></li>
        <li class="active">Create Expense Receipt</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">           
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/insert_voucher_receipt" method="POST" enctype="multipart/form-data">
                @csrf
                 <div class="box-body">
              
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="exampleName">Expense No</label>
                                                <input type="text" class="form-control" id="voucher_no" name="voucher_no" aria-describedby="emailHelp" placeholder="Expense No" value="{{ $voucher_no }}" readonly="true" required="true">
                                            </div>
                                        </div> 
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="voucher_date" name="voucher_date" aria-describedby="emailHelp" placeholder="Expense Date" onkeypress="javascript:return isNumber(event)"  required="true">
                                            </div>
                                        </div>

                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="exampleName">Expense Category</label>
                                                <select class="form-control select2" name="voucher_category" id="voucher_category"  required="true">
                                                  <option value="">Select </option>
                                                    @foreach($voucher_categorys as $voucher_category)
                                                    <option value="{{$voucher_category->id}}">{{$voucher_category->voucher_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="exampleName"> Person Name ( Head of AC )</label>
              ...
              <div class="box-footer">
                ...
                <button type="submit" value="save_print"  name="btn_click" id="btn_click" class="btn btn-success">Save and Print</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
