              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @if($fetch_sales_booking->delivery_note_status == '1')
                   ...
                   <tr>                      
                      <td>{{ $count }}</td>
                       <td>{{ date("d-m-Y", strtotime($fetch_sales_booking->booking_date)) }}
                         <a href="/sale_booking_ledger_print/{{ $fetch_sales_booking->order_id }}" target="_blank"><button class="btn btn-info"><i class="fa fa-print"title="Print"></i></button></a> 
                         </td>
                      ...
                      <td>
                        <?php
                          ...
                          {
                            ?>
                             <center> <button class="btn btn-info-status"><i class="fa fa-times" title="Not Closed!"> </i></button></center>
                            <?php
                          }
                          else
                           {
                            ?>
                            <center>  <button class="btn btn-info-status"><i class="fa fa-check" title="Closed!"> </i></button></a></center>
                            <?php
                          }
                        ?>
                       ...
                       <td>
                         <?php
                          ...
                          {
                            ?>
                             <center> <button class="btn btn-danger"><i class="fa fa-times" title="Not Deleted!"> </i></button></center>
                            <?php
                          }
                          else
                           {
                            ?>
                            <center>  <button class="btn btn-warning "><i class="fa fa-check" title="Deleted!"> </i></button></center>
                            <?php
                          }
                        ?> 
                      </td>
                       <td>
                          ...
                          {
                            ?>
                             <center> <button class="btn btn-cancel"><i class="fa fa-times" title="Not Canceled!"> </i></button></center>
                            <?php
                          }
                          else
                          {
                       ...
                       <td>
                          ...
                          else
                          {
                            ?>
                              ...
                              <center><button class="btn btn-warning "><i class="fa fa-check" title="Canceled!"> </i></button> <button class="btn btn-info"><a href="/reupdate_cancel/{{ $fetch_sales_booking->order_id }}" onclick="return confirm('Are you sure want to re-update this cancel order?')"><i class="fa fa-refresh"title="Re-update"></i></a></center>
                            <?php
                          }
                        ?>
                      </td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <tbody>                
                    ...
                    <tr><td>Sales Executive </td> <td> <input class="book-info"  name="sales_person" id="sales_person" value="">  </td></tr>
