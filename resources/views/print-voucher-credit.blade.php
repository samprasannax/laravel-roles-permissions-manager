	...
	<div class="main-div">
		 ...
		 <div class="header">
		 	...
		 	<div class="header-left">
		 		...
		 		<p style="font-weight: bold;">Cell : 78787 98989 </p>
		 	</div>
		 ...
		 <div class="body-content">
		 	<p>Head of A/C <span class="underline1"><?php echo $print_voucher_receipt[0]->person_name ?></span> Received with thanks Rupees  <span class="underline2" ><?php echo $result; ?></span> on account of <span class="underline3"><?php echo "Credit"; ?></span> </p>		 	
		 </div>
