		...
		else
		{
			 ...
			 $bank_percentage = DB::table('bank')
					...
					*/
						...
						array_push($ledger_report_items,new AsscSalesPercentage("Cash / Finance","Percentage","Count"));
                            ...
                            if($total_sales_count !=0)
                            {
							 ...
							 array_push($ledger_report_items,new AsscSalesPercentage("CASH",$cash,$fetch_cash_count));
                            }
                            else
                            {
							...
							if($bank_percentage !='')
							{
								foreach ($bank_percentage as $farray ) {
							        ...
							        array_push($ledger_report_items,new AsscSalesPercentage($bank_name,$finanace,$total_count));
                            ...
                            if($total_sales_count !=0)
                            {
							 ...
							 array_push($ledger_report_items,new AsscSalesPercentage("TOTAL",$total,$total_sales_count));
                            }
                            else
                            {
