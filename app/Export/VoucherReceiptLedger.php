    ...
    public function collection()
    {
            ...
            $rto_date = $report_to_date;
              ...
              $voucher_receipt_report_lists = DB::table('voucher_receipt')
						...
						array_push($voucher_receipt_items,new VoucherReceiptReport("","","Report Date: ".$report_date,"","","",""));


						array_push($voucher_receipt_items,new VoucherReceiptReport("Voucher No","Voucher Date","Person Name","Voucher Category","Amount","Description","Payment Mode"));
						...
						if(!empty($voucher_receipt_report_lists))
						{
								foreach ($voucher_receipt_report_lists as $farray ) {
									...
									array_push($voucher_receipt_items,new VoucherReceiptReport("Voucher No:".$voucher_no,$voucher_date1,$person_name,$voucher_name,$voucher_amount,$voucher_description,$payment_mode));

									array_push($voucher_receipt_items,new VoucherReceiptReport("","","","","","",""));
