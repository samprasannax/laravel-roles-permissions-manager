    ...
    public function collection()
    {
            ...
            $rto_date = $report_to_date;
               ...
               $vehicle_stocks = DB::table('self_sale_vehicle_info')
						...
						array_push($array_of_sold_stock,new SoldVehicleStock("Purchase Date","Sold Date","Vehicle Type","Vehicle Model","Vehicle Color","Chassis No","Engine No","Customer Name","Contact No","Dsc Name","RTO Date","Vehicle No"));
						...
						if(!empty($vehicle_stocks))
						{
								foreach ($vehicle_stocks as $farray ) {
									...
									$vehicle_no = strtoupper($farray->vehicle_no);
									...
									{
									    $rto_date="RTO Not checked..!";
									}

															

									array_push($array_of_sold_stock,new SoldVehicleStock($purchase_date,$sold_date,$vehicle_type,$vehicle_model,$vehicle_color,$chassis_no,$engine_no,$customer_name,$contact_no1,$sales_person_name,$rto_date,$vehicle_no));
