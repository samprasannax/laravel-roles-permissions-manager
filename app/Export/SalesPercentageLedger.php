...
class SalesPercentageLedger implements FromCollection
{
    ...
    */
    public function collection()
    {
            ...
            $total_sale_count = DB::table('self_sale_vehicle_info')
                               ->whereBetween("self_sale_vehicle_info.delivery_date",[$report_from_date, $report_to_date])
                               	->where("self_sale_vehicle_info.is_deleted","=", 0)
  ...
  $sale_booking_in_cash = DB::table('sale_booking')           							
           	 ...
           	 $bank_percentage = DB::table('bank')
					...
					*/
						...
						array_push($ledger_report_items,new SalesPercentage("Cash / Finance","Percentage","Count"));
							...
							if($sale_booking_in_cash !='')
							{
								foreach ($sale_booking_in_cash as $farray ) {
							        ...
							        array_push($ledger_report_items,new SalesPercentage("CASH",$cash."%",$total_count));
							...
							if($bank_percentage !='')
							{
								foreach ($bank_percentage as $freceipt ) {
							        ...
							        array_push($ledger_report_items,new SalesPercentage($bank_name,$finance."%",$total_count));
							...
							if($total_sale_count !=0)
							{
				                    ...
				                    $total_sales ='100%';
				                    array_push($ledger_report_items,new SalesPercentage("TOTAL",$total_sales,$total_sale_count));
							}
